...
const into_template = (code: string) => {
...
let navbar_unregistered_template = document.createElement('template')
navbar_unregistered_template.innerHTML = `
<div class="sticky top-0 flex w-full h-24 bg-primary">
    <div class="flex-none flex space-x-3 left-2 top-6 absolute cursor-pointer" onclick="location.href='/'">
    ...
    <div class="right-2 top-6 absolute bg-accent w-fit px-4 py-2 font-bold rounded-lg mx-auto sm:mx-0">Join</div>
</div>
`
